    ...
    return (
        <div className="min-h-screen w-full bg-slate-50 font-sans text-slate-900 overflow-hidden">
            ...
            <div className="min-h-screen flex">
                ...
                <section className="hidden lg:flex lg:w-[55%] relative overflow-hidden bg-gradient-to-br from-[#061525] via-[#0B2745] to-[#123B5D]">

                    {/* Background glow */}
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(37,97,143,0.25),transparent_28%),radial-gradient(circle_at_85%_80%,rgba(16,185,129,0.08),transparent_30%)]" />
                    ...
                    <span className="absolute top-[25%] left-[28%] w-1 h-1 rounded-full bg-white/50" />

                    <span className="absolute top-[12%] right-[22%] w-1.5 h-1.5 rounded-full bg-white/70 shadow-[0_0_12px_rgba(255,255,255,0.7)]" />

                    <span className="absolute top-[38%] right-[14%] w-1 h-1 rounded-full bg-white/50" />

                    <span className="absolute top-[55%] left-[10%] w-1 h-1 rounded-full bg-white/50" />

                    <span className="absolute top-[46%] left-[42%] w-1 h-1 rounded-full bg-white/40" />

                    {/* Decorative lines */}
                    <div className="absolute top-[18%] right-[30%] w-16 h-px rotate-[-35deg] bg-gradient-to-r from-transparent via-white/60 to-transparent" />

                    <div className="absolute top-[32%] left-[20%] w-12 h-px rotate-[-50deg] bg-gradient-to-r from-transparent via-white/50 to-transparent" />
                    ...
                    <div className="relative z-10 w-full min-h-screen flex flex-col justify-between px-10 py-10 xl:px-16 xl:py-12">
                        ...
                        <div className="relative max-w-xl">
                            ...
                            <p className="mt-6 max-w-lg text-sm leading-7 text-white/55">
                                Manage your home, complaints, visitors,
                                amenities, payments and community updates
                        ...
                        <div className="relative h-40 -mx-10 xl:-mx-16 mt-8">
                            ...
                            <div className="absolute right-[17%] top-0 w-20 h-20 rounded-full bg-white/10 shadow-[0_0_70px_rgba(221,214,254,0.10)]" />
                ...
                <section className="relative flex w-full lg:w-[45%] min-h-screen items-center justify-center px-5 py-8 sm:px-10">
                    ...
                    <div className="relative z-10 w-full max-w-md">
                        ...
                        <div className="flex lg:hidden items-center justify-center gap-3 mb-10">
                            ...
                            <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-[#123F63] to-[#18557F] flex items-center justify-center shadow-lg shadow-[#0B2745]/20">
                        ...
                        <div className="bg-white rounded-[28px] border border-slate-200/80 shadow-[0_25px_80px_rgba(15,23,42,0.10)] p-6 sm:p-8">
                            ...
                            <div className="mb-7">
                                ...
                                <div className="w-12 h-12 rounded-2xl bg-[#EDF4F9] flex items-center justify-center mb-5">

                                    <Lock className="w-5 h-5 text-[#123F63]" />
                            ...
                            <div className="mb-7">
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    ...
                                    <button
                                        ...
                                        className={`relative flex flex-col items-center gap-2 rounded-2xl border px-2 py-3.5 transition-all duration-200 ${
                                            selectedRole === 'resident'
                                                ? 'border-[#A9C8DD] bg-[#EDF4F9] text-[#123F63] shadow-sm'
                                    ...
                                    >
                                        ...
                                        {selectedRole === 'resident' && (
                                            <span className="absolute right-2 top-2 w-1.5 h-1.5 rounded-full bg-[#123F63]" />
                                        )}
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        ...
                                        <input
                                            ...
                                            className="w-4 h-4 rounded border-slate-300 text-[#123F63] focus:ring-[#18557F]"
                                        />
                                    ...
                                    <button
                                        ...
                                        className="text-xs font-bold text-[#123F63] hover:text-[#18557F] transition-colors"
                                    >
                                        Forgot password?
                                    </button>
                                ...
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className="group w-full h-12 rounded-2xl bg-gradient-to-r from-[#123F63] to-[#18557F] text-sm font-bold text-white shadow-lg shadow-[#0B2745]/25 hover:shadow-xl hover:shadow-[#0B2745]/30 hover:from-[#18557F] hover:to-[#1D638F] active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-70 transition-all duration-200 flex items-center justify-center gap-2"
                                >
                        ...
                        <div className="mt-5 text-center">
                            ...
                            <div className="flex justify-center gap-2">
                                ...
                                <button
                                    ...
                                    className="text-[10px] font-semibold text-slate-400 hover:text-[#123F63] transition-colors"
                                >
                                    Resident
                                </button>
